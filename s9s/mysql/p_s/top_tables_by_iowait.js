...
var DESCRIPTION="This advisor selects the top 10 tables, sorted by the sum of IO wait, from performance_schame";
query="SELECT object_schema, object_name, count_star, sum_timer_wait"
      " FROM performance_schema.table_io_waits_summary_by_table"
      " ORDER BY 4 DESC LIMIT 10";

var hosts     = cluster::mySqlNodes();
print("Top 10 Tables by I/O Wait Per Server<br/><br/>");
...
for (idx = 0; idx < hosts.size(); ++idx)
{
    ...
    else
    {
        ...
        print("<tr><td width=20%>Schema</td>"
              ...
              "<td width=20%>Sum I/O wait</td></tr>");
