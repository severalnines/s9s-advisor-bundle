...
function main(mydb, table, user, hostname, hostAndPort)
{
    ...
    result["accounts"] = {};
    var query = "";
    query = "SELECT grantee as account, table_schema as db, table_name as `table`, "
    ...
    query += " group by grantee, table_schema, table_name order by grantee asc";
